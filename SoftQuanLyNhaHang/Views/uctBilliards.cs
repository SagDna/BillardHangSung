...
namespace QuanLyBillards.Views
{
    public partial class uctBilliards : UserControl
    {
        ...
        private void createReceipt(object sender, PrintPageEventArgs e)
        {
            ...
            string _header = "Club Billiards HangSung";
            string _line = "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -";
            //tiêu đề
            ...
            y += e.Graphics.MeasureString(txtReceiptionid.Text, drawFontArial10Regular).Height;
            //kết thúc
            graphic.DrawString("Rất vui vì quý khách đã tin tưởng lựa chọn", drawFontArial10Regular, drawBrush, new RectangleF(x, y, width, height), drawFormatCenter);
            y += e.Graphics.MeasureString(_header, drawFontArial16Bold).Height;
        ...
        private void txtDeskname_TextChanged(object sender, EventArgs e)
        {
